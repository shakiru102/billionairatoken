...
export const translationEnglish: TranslationProps = {
  ...
  whatAboutTokenizedAssetContent:
    "With the continued failure of centralized exchanges, crypto is seeing a return to first principles: new and seasoned investors alike are embracing the trustless, non-custodial, decentralized nature of on-chain finance. BlowX is rewriting the rules of investment, and you're invited to the front row seat. <linkRef>View Our Whitepaper to see our Full Solution-Based Ecosystem</linkRef>",
  ...
  blowIslandsContent:
    "Escape to the luxurious Blow Island & Casino, an exclusive paradise located in Ras Al Khaimah, UAE, and El Salvador Bitcoin City. Enjoy world-class gaming, lavish accommodations, gourmet dining experiences, exciting entertainment options, and VIP services. Experience luxury and entertainment like never before, exclusively for BLOW prime hodlers and VVIPs.",
  blowIslandsContentLink:
    "(Discover) Blow Island & Casino and plan your unforgettable experience today!",
